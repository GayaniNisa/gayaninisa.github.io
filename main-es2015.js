...
let DetailsHospitalsComponent = class DetailsHospitalsComponent {
...
DetailsHospitalsComponent.ctorParameters = () => [
    { type: _services_api_service_service__WEBPACK_IMPORTED_MODULE_2__["ApiServiceService"] }
];
...
let RightGlobalComponent = class RightGlobalComponent {
    constructor(serviceAPI) {
        this.serviceAPI = serviceAPI;
        this.serviceAPI.getCovidUpdates().subscribe(data => {
            // console.log(data.data.global_new_cases)
...
RightGlobalComponent.ctorParameters = () => [
    { type: _services_api_service_service__WEBPACK_IMPORTED_MODULE_2__["ApiServiceService"] }
];
...
let RightLocalComponent = class RightLocalComponent {
    constructor(serviceAPI) {
        this.serviceAPI = serviceAPI;
        this.serviceAPI.getCovidUpdates().subscribe(data => {
            // console.log(data.data.global_new_cases)
...
RightLocalComponent.ctorParameters = () => [
    { type: _services_api_service_service__WEBPACK_IMPORTED_MODULE_2__["ApiServiceService"] }
];
...
let RightPcrComponent = class RightPcrComponent {
    constructor(serviceAPI) {
        this.serviceAPI = serviceAPI;
        this.serviceAPI.getCovidUpdates().subscribe(data => {
            // console.log(data.data.global_new_cases)
...
RightPcrComponent.ctorParameters = () => [
    { type: _services_api_service_service__WEBPACK_IMPORTED_MODULE_2__["ApiServiceService"] }
];
...
class HospitalDetails {
    constructor(id, hospital_id, cumulative_local, cumulative_foreign, treatment_local, treatment_foreign, created_at, updated_at, deleted_at, cumulative_total, treatment_total, hospital) {
        this.id = id;
...
HospitalDetails.ctorParameters = () => [
    { type: Number },
    { type: Number },
    { type: Number },
    { type: Number },
...
class Hospital {
    constructor(id, name, name_si, name_ta, created_at, updated_at, deleted_at) {
        this.id = id;
        this.name = name;
